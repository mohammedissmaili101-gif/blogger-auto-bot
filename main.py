...
def generate_meta(topic, used_titles=[]):
    ...
    user_msg = (
        ...
        "- Style examples: Why Europe AI Rules Are Backfiring | "
        "The Hidden Cost of Cheap Chips | When Quantum Meets Encryption\n\n"
...
def main():
    ...
    # 3. جلب أخبار متعمقة للموضوع المختار
    print(f"📡 Fetching deep news for: {newsapi_query}")
    articles     = fetch_real_news(newsapi_query, max_articles=7)
